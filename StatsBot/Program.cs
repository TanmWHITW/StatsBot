...
using StatsBot.Commands.BaseCommands;
using System.Text;
...
namespace StatsBot
{
    public class Program
    {
        ...
        public async Task RunBotAsync()
        {
            ...
            var cfgjson = JsonConvert.DeserializeObject<JsonConfiguration>(json);
            ...
            Commands.RegisterCommands<PingPongCommand>();
        ...
        private Task Client_GuildAvailable(DiscordClient sender, GuildCreateEventArgs e)
        {
            ...
            // sent to our client
            sender.Logger.LogInformation(BotEventId, $"Guild available: {e.Guild.Name}, {e.Guild.Id}");
